...
@Composable
fun LoadingScreen(navController: NavController, viewModel: MainViewModel = hiltViewModel()) {
            ...
            Column() {
                ...
                Button(
                    ...
                    onClick = {
                        ...
                        viewModel.updateOrderStatus(orderState[nr].orderID, "LOADED")
                    },
                    enabled = selected,
                    modifier = Modifier.width(200.dp)
                ) {
